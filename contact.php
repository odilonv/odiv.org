...
<header>
    <nav>
        ...
        <a href="./odiv.org"><img src="assets/img/LOGO.webp" alt="Logo Odiv" CLASS="logo"></a>

        <a aria-label="contact" href="./odiv.org/contact" class="contact-circle">
        ...
        <div class="container-corner">
            <div class="circle-menu">
                <a href="./odiv.org/#apropos" class="links-circle">01. PRESENTATION</a>
                <a href="./odiv.org/#competences" class="links-circle">02. COMPETENCES</a>
                <a href="./odiv.org/#portfolio" class="links-circle">03. PORTFOLIO</a>
            </div>
